...
public class UserRegistration {
  ...
  /**
   * La contraseña debe contener al menos un dígito, una mayúscula y una minúscula.
   * @return password
   */
  @NotNull @Pattern(regexp = "^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).*$") @Size(min = 8) 
  @Schema(name = "password", description = "La contraseña debe contener al menos un dígito, una mayúscula y una minúscula.", requiredMode = Schema.RequiredMode.REQUIRED)
